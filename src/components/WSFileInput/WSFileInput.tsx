import React, { FC, InputHTMLAttributes, useEffect, useState, forwardRef } from 'react';
...
const WSFileInput: FC<WSFileInputProps> = forwardRef<HTMLInputElement, WSFileInputProps>(
  ({ className = '', requiredMessage = '', intermediate = false, error = null, required = false, label, id, name, ...props }, ref) => {
